...
<!--Adobe Edge Runtime End-->
	...
	<div id="stage" class="EDGE-3735892">
      ...
      <div class="colelem" id="n116"><!-- custom html -->
       <?php
  include("db.php");
echo '<form name="Albenauswahl" action="kaufalbum.php" method="POST" enctype="text/html">'  ;


$liste = mysql_query ( "SELECT * FROM `tblalbum` ");

echo '<table border="0" cellpadding="1" cellspacing="1" summary="" bgcolor="d2d0d0" c>
   <tr>
   <th>Auswahl</th>
...
{ ?>
    <td style="width: 100px;"> <input type='radio' name='Albumauswahl' ;
       <?PHP     echo "value='$zeile[albnr]'"; ?> checked="checked" </td>
     <?php echo "
       <td>$zeile[albnr]</td>
       <td> $zeile[albname]</td>
       <td>$zeile[albpreis]&euro;</td>

        </tr>   "   ;
}
echo '</table>';
echo '<input type="submit" name="" value="Ausw&auml;hlen" />';
