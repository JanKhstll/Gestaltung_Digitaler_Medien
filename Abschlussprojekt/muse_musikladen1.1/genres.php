...
<!--Adobe Edge Runtime End-->
   ...
   include("db.php");
 echo '<form name="Auswahl_Interpret" action="Genrewahl.php" method="POST" enctype="text/html">  '   ;

$liste = mysql_query ( "SELECT * FROM `tblgenre` ");
 ?>
<table border = '0'>
   <tr>
   <th style="width: 100px;">Wahl</th>
   <th style="width: 115px;">Genre</th>
       </tr>
...
<table border="0" cellpadding="2" cellspacing="2" summary="">
    <tr>
    <td style="width: 100px;"> <input type='radio' name='Genrenummer' ;
       <?PHP     echo "value='$zeile[genreNr]'"; ?> checked="checked" </td>
        <td style="width: 115px;"><?PHP echo $zeile['genre'];?></td>
