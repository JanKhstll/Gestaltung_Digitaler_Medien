...
<!--Adobe Edge Runtime End-->
 ...
 echo '<form name="Auswahl_Interpret" action="Wahllied.php" method="POST" enctype="text/html">  '   ;
  include("db.php");

$liste = mysql_query ( "SELECT * FROM `tblinterpret` ");

echo "   <tr>
   <th>W&auml;hlen Sie einen Interpreten aus!</th>

    </tr>    ";

echo "<table border='0' cellpadding='2' cellspacing='2' summary='' bgcolor='d2d0d0'>
    <tr>
            <td style='width: 100px;'><b>Auswahl </b></td>
            <td style='width: 100px;'><b>Interpret Nr. </b></td>
        <td style='width: 125px;'><b>Interpretenname</b></td>

    </tr>";

          while ($zeile = mysql_fetch_array($liste))   { ?>

<table border="0" cellpadding="2" cellspacing="2" summary="" bgcolor="d2d0d0">
    <tr>
    <td style="width: 100px;"> <input type='radio' name='Interpretennummer' ;
       <?PHP     echo "value='$zeile[InterNr]'"; ?> checked="checked" </td>
        <td style="width: 100px;"><?PHP echo $zeile['InterNr'];?></td>
        <td style="width: 125px;"><?PHP echo $zeile['InterName'];?></td>
