...
<html>
 <head>
  ...
  <title>Genrewahl</title>
  <!-- CSS -->
  <link rel="stylesheet" type="text/css" href="css/site_global.css"/>
  <link rel="stylesheet" type="text/css" href="css/genrewahl.css"/>
  <!-- Other scripts -->
...
<!--Adobe Edge Runtime-->
    ...
    <script type="text/javascript" charset="utf-8" src="Genres_edge.js"></script>
    <script type="text/javascript" charset="utf-8" src="Genres_edgeActions.js"></script>
    <link rel="stylesheet" href="Genres_edge.css" />
...
echo  '<form name="Liedkauf" action="kauf.php" method="POST" enctype="text/html">' ;
   ...
   $suche = $_POST["Genrenummer"]  ;

   $res = mysql_query("SELECT genre FROM tblgenre
                                   WHERE genreNr =\"$suche\"");
  $genre = mysql_result($res, 0, "genre");

echo "Alle Lieder des Genres "; echo "$genre.<br />"   ;
echo "<br />"      ;
...
echo "<table border='0' cellpadding='2' cellspacing='2' summary='' bgcolor='#d2d0d0'>
  ...
  $sql = "SELECT * FROM `tbllied` LEFT JOIN (tblinterpret,tblalbum) ON
(tbllied.InterNr=tblinterpret.InterNr AND tbllied.AlbNr=tblalbum.AlbNr) WHERE `genreNr` LIKE '$suche' ";
